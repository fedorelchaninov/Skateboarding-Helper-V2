...
fun TrickDetailsScreen(trick: Trick, onBack: () -> Unit) {
    var shouldOpenYoutubeLink by remember {
    ...
    Scaffold(
        ...
        Column(
            ...
            Button(
                onClick = {
                    trick.youtubeLink?.let {
                        shouldOpenYoutubeLink = true
                    }
                },
                modifier = Modifier
                    .fillMaxWidth()
    ...
    if (shouldOpenYoutubeLink) {
        openYouTubeLink(trick.youtubeLink!!)
    }
}

@Composable
fun openYouTubeLink(url: String) {
